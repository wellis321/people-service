...
<head>
    ...
    <meta name="description" content="People Service — person-centred care management for social care providers. Profiles, care needs, key workers and more.">
    ...
    <div class="container">
        <nav>
            <a href="<?php echo url('landing.php'); ?>" class="logo">
                <i class="fas fa-heart-pulse" style="font-size:1.75rem"></i>
