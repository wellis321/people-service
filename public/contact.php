...
.contact-info {
    background: #f5f3ff; border: 1px solid #c4b5fd; border-radius: 0.5rem;
    padding: 1.5rem; margin-bottom: 2rem;
}
.contact-info h3 { color: #4c1d95; font-size: 1.1rem; margin-bottom: 0.5rem; }
.contact-info p { color: #4b5563; line-height: 1.6; font-size: 0.95rem; margin-bottom: 0.25rem; }
.contact-info a { color: #7c3aed; text-decoration: none; }
.contact-info a:hover { text-decoration: underline; }
.contact-form { background: white; padding: 2rem; border-radius: 0.75rem; box-shadow: 0 2px 12px rgba(0,0,0,0.08); }
.contact-form .btn-submit {
    background: #7c3aed; color: white; padding: 0.75rem 2rem; border: none;
    border-radius: 0.375rem; font-size: 1rem; font-weight: 600; cursor: pointer;
    transition: background 0.2s;
}
.contact-form .btn-submit:hover { background: #6d28d9; }
</style>

<div class="contact-wrap">
    <h1><i class="fas fa-envelope" style="color:#7c3aed"></i> Contact Us</h1>
    <p class="lead">Have a question about People Service? Get in touch and we'll get back to you.</p>
