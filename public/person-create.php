...
$data   = [
    ...
    'status' => 'active', 'support_start' => '', 'support_end' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!CSRF::validateToken($_POST[CSRF_TOKEN_NAME] ?? '')) {
        ...
        if (empty($errors)) {
            $id = Person::create($organisationId, $data);
            header('Location: ' . url('person-view.php?id=' . $id . '&msg=created'));
            exit;
        }
    }
}
...
<div class="page-header">
    <h1><i class="fa-solid fa-user-plus"></i> Add Person</h1>
    <a href="<?php echo url('people.php'); ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Back</a>
</div>
...
<form method="POST" action="">
    ...
    <div class="d-flex gap-1 mt-2" style="padding-bottom:2rem">
        <button type="submit" class="btn btn-primary"><i class="fa-solid fa-check"></i> Save Person</button>
        <a href="<?php echo url('people.php'); ?>" class="btn btn-secondary">Cancel</a>
    </div>
</form>
