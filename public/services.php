...
.service-card.current { border-color: #7c3aed; }
...
.service-card-header .badge-current {
    ...
    background: #f3e8ff; color: #6d28d9; padding: 0.2rem 0.5rem; border-radius: 999px;
...
<div class="services-wrap">
    ...
    <div class="services-hero">
        <h1><i class="fas fa-cubes" style="color:#7c3aed;margin-right:.5rem"></i> Our Platform</h1>
    ...
    <div class="services-grid">
        ...
        <div class="service-card current">
            ...
            <div class="service-card-footer">
                <a href="<?php echo url('landing.php'); ?>" class="btn-visit people">
