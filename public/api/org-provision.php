...
// Derive slug from domain (People Service requires slug NOT NULL)
$slug = substr(preg_replace('/[^a-z0-9]+/', '-', strtolower($domain)), 0, 100);
$slug = trim($slug, '-');
...
try {
    ...
    if (str_contains($e->getMessage(), 'Duplicate')) {
        ...
        echo json_encode(['error' => 'An organisation with that domain or slug already exists on this service']);
    } else {
