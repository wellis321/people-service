...
$errors = [];
$data   = ['category' => '', 'description' => '', 'severity' => '', 'review_date' => ''];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!CSRF::validateToken($_POST[CSRF_TOKEN_NAME] ?? '')) {
        ...
        if (empty($errors)) {
            CareNeed::create($personId, $organisationId, $userId, $data);
...
$pageTitle = 'Add Care Need — ' . $person['first_name'] . ' ' . $person['last_name'];
include INCLUDES_PATH . '/header.php';
?>

<div class="page-header">
    <h1><i class="fa-solid fa-hand-holding-medical"></i> Add Care Need</h1>
    ...
    <div class="card" style="max-width:580px">
        <div class="form-group">
            ...
            <input type="text" id="category" name="category" class="form-control" required
                   placeholder="e.g. Communication, Mobility, Personal Care, Nutrition"
